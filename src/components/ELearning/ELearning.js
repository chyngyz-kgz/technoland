    ...
    return (
        <>
            ...
            <div className="news-details__container">
                ...
                <span className="news-details__image-description">Апрель 06, 2020</span>
                ...
                <span className="news-details__image-description">Апрель 04, 2020</span>
                ...
                <span className="news-details__image-description">Апрель 01, 2020</span>
                ...
                <span className="news-details__image-description">Март 28, 2020</span>
                ...
                <span className="news-details__image-description">Март 26, 2020</span>
                ...
                <span className="news-details__image-description">Март 23, 2020</span>
            </div>
        </>
    );
};
