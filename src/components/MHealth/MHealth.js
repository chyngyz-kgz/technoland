    ...
    return (
        <>
            ...
            <div className="news-details__container">
                ...
                <span className="news-details__image-description"><DateRangeIcon />Ноябрь 27, 2019</span>
                ...
                <span className="news-details__image-description"><DateRangeIcon />Октябрь 23, 2018</span>
            </div>
        </>
    );
};
